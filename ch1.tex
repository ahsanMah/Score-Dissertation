...
\subsection*{Why would multiscale scores capture outliers?}
\label{neighborhoods}
...
\caption{Comparison of auxiliary models tasked to separate CIFAR-10 (inlier) and SVHN (out-of-distribution). $\downarrow$ indicates lower values are better and $\uparrow$ indicates higher values are better.}
\label{cifar_perf}
\end{table}
