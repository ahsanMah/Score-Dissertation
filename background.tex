...
\tempcite{Vincent} showed that under certain regularity conditions
...
Unsupervised anomaly detection has been tackled by a myriad of methods \cite{pang_deep_2021,ruff_unifying_2021}, with varying success~\cite{han2022adbench}. This section provides a summary of some methodologies relevant to my research.
...
\textbf{Autoregressive} models such as Glow and PixelCNN (and their earlier counterparts, NADE and MADE) allow direct access to density estimates. However, \tempcite{Nalisnick} showed that deep likelihood models often fail to detect out-of-distribution samples.
